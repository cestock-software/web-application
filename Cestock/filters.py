...
class PacienteFilter(django_filters.FilterSet):
    ...
    # ap_paterno = CharFilter(label='Apellido Paterno: ',field_name='ap_paterno', lookup_expr='icontains')
    # ap_materno = CharFilter(label='Apellido Materno: ',field_name='ap_materno', lookup_expr='icontains')
